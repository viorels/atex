...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'atex_web_customuser', 'phone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=15, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.address'
        db.add_column(u'atex_web_customuser', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.city'
        db.add_column(u'atex_web_customuser', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding field 'CustomUser.county'
        db.add_column(u'atex_web_customuser', 'county',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)

        # Adding index on 'CustomUser', fields ['email']
        db.create_index(u'atex_web_customuser', ['email'])

        # Adding unique constraint on 'CustomUser', fields ['email']
        db.create_unique(u'atex_web_customuser', ['email'])


    def backwards(self, orm):
        # Removing unique constraint on 'CustomUser', fields ['email']
        db.delete_unique(u'atex_web_customuser', ['email'])

        # Removing index on 'CustomUser', fields ['email']
        db.delete_index(u'atex_web_customuser', ['email'])
        ...
        db.delete_column(u'atex_web_customuser', 'phone')

        # Deleting field 'CustomUser.address'
        db.delete_column(u'atex_web_customuser', 'address')

        # Deleting field 'CustomUser.city'
        db.delete_column(u'atex_web_customuser', 'city')

        # Deleting field 'CustomUser.county'
        db.delete_column(u'atex_web_customuser', 'county')
