...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CustomUser.ancora_id'
        db.add_column(u'atex_web_customuser', 'ancora_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CustomUser.ancora_id'
        db.delete_column(u'atex_web_customuser', 'ancora_id')
