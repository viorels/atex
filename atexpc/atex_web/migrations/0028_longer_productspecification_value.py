...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProductSpecification.value'
        db.alter_column(u'atex_web_productspecification', 'value', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'ProductSpecification.value'
        db.alter_column(u'atex_web_productspecification', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
