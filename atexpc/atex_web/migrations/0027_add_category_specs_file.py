...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.specs_file'
        db.add_column(u'atex_web_category', 'specs_file',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.specs_file'
        db.delete_column(u'atex_web_category', 'specs_file')
